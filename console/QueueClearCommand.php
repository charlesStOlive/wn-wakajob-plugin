<?php namespace Waka\Wakajob\Console;

use Illuminate\Console\Command;
use Illuminate\Contracts\Config\Repository;
use Illuminate\Queue\QueueManager;
use Waka\Wakajob\Classes\Clearer;
...
class QueueClearCommand extends Command
{
     ...
     */
    public function __construct(Repository $config, ClearerContract $clearer)
    {
        $this->config = $config;
    ...
    {
        return [
            ['connection', InputArgument::OPTIONAL, 'The connection of the queue driver to clear.'],
            ['queue', InputArgument::OPTIONAL, 'The name of the queue / pipe to clear.'],
        ];
    }
